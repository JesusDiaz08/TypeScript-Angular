...
var Profesor = /** @class */ (function () {
    ...
    __decorate([
        __param(0, decorador_parametro), __param(2, decorador_parametro)
    ], Profesor.prototype, "saludar", null);
    return Profesor;
}());
var jesus = new Profesor();
jesus.saludar('Hola', 'X', 'Y');
console.log(Object.getPrototypeOf(jesus));
function decorador_parametro(objetivo, metodo, indice) {
    var metadata = "indices_decorados";
